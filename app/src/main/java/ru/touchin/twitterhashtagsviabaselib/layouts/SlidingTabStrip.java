package ru.touchin.twitterhashtagsviabaselib.layouts;
...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        mDefaultBottomBorderColor = DEFAULT_SELECTED_INDICATOR_COLOR;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0, 0, getWidth(), mBottomBorderThickness, mTopBorderPaint);
    }
